...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "IDAPayNetwork") type = IDAPayNetwork;
    if(strType == "IDAPayNetworkVariable") type = IDAPayNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == IDAPayNetwork) s = "IDAPayNetwork";
    if(type == IDAPayNetworkVariable) s = "IDAPayNetworkVariable";
