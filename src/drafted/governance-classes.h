 ...
 *
 *   // network
 *   CIDAPayNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.idapay.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CIDAPayNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: IDAPayNetwork
// //   -- signature requirements : Key1(User)
// class CIDAPayNetworkVariable : public CGovernanceObject
// {
// private:
