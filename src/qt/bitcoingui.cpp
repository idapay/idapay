    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("IDAPay Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a IDAPay address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and idapay: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About IDAPay Core"), this);
    aboutAction->setStatusTip(tr("Show information about IDAPay Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for IDAPay Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your IDAPay addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified IDAPay addresses"));
    ...
    openAction->setStatusTip(tr("Open a idapay: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the IDAPay Core help message to get a list with possible IDAPay Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("IDAPay Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to IDAPay network", "", count));
    } else {
...
{
    QString strTitle = tr("IDAPay Core"); // default title
