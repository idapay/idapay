    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("IDAPay Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About IDAPay Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  idapay-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the IDAPay in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 IDAPAY, 0.1 IDAPAY, 1 IDAPAY and 10 IDAPAY -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://idapaypay.atlassian.net/wiki/display/DOC/PrivateSend\">https://idapaypay.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("IDAPay Core is shutting down...") + "<br /><br />" +
