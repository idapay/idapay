...
#define BOOST_TEST_MODULE IDAPay Test Suite

#include "test_idapay.h"
...
#endif
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_idapay_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
