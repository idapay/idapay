...
IDAPay Core is a multithreaded application, and deadlocks or other multithreading bugs
...
- ThreadSocketHandler : Sends/Receives data from peers on port 19285.
...
However, in open source software such as IDAPay Core, where everyone uses
...
pay attention to for reviewers of IDAPay Core code.
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: IDAPay Core uses tinyformat, which is type safe. Leave them out to avoid confusion
