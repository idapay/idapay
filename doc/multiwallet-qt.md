...
Only requiring some minor changes is idapay.cpp.
...
Changes to idapay.cpp
----------------------
idapay.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
