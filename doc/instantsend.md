...
This mechanism has been integrated into Bitcore-Node-IDAPay which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/idapaypay/insight-api-idapay#web-socket-api](https://github.com/idapaypay/insight-api-idapay#web-socket-api)
* API: [https://github.com/idapaypay/insight-api-idapay#instantsend-transactions](https://github.com/idapaypay/insight-api-idapay#instantsend-transactions)
...
By default, the IDAPay Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the IDAPay Core daemon:
